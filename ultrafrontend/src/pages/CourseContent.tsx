    ...
    <div className="flex h-screen">
      ...
      <div className="flex-1 overflow-y-auto p-6 ">
        ...
        <span>
          ...
          an advertising platform, a social network, a vanity press, an
          experiment in anarchy or democracy, an indiscriminate collection of
          information, nor a web directory. It is not a dictionary, a newspaper,
          nor a collection of source documents,
        </span>
