  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="flex-1 overflow-y-auto p-6 ">
        ...
        <br></br>
        <span>
          The principle "Wikipedia has no firm rules" (often abbreviated as IAR
          for "Ignore All Rules") reflects Wikipedia's pragmatic approach to
          governance. This guideline suggests: If a rule prevents you from
          improving Wikipedia, you can ignore it Common sense and improving the
          encyclopedia take precedence over strict adherence to policies Rules
          should be interpreted with flexibility rather than rigidity Policies  
          exist to help the project, not hinder it Editorial judgment sometimes
          requires breaking from standard practices
        </span>
