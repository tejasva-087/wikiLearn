  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="flex-1 overflow-y-auto p-6 ">
        ...
        <br></br>
        <span>
          Wikipedia is written from a neutral point of view (NPOV), which is one
          of its core content policies. This principle requires that articles
          present information fairly, proportionately, and without bias. NPOV
          means: Wikipedia articles aim to represent all significant viewpoints
          on a topic without advocating for any particular position Content is
          presented using neutral language that avoids judgment or opinion
          Coverage gives due weight to various perspectives based on their
          prominence in reliable sources Controversial claims are attributed to
          their sources rather than presented as facts
        </span>
