  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="flex-1 overflow-y-auto p-6 ">
        ...
        <br></br>
        <span>
          Wikipedia's free content policy is a foundational principle that
          allows anyone to use, edit, and distribute its content. This means:
          Anyone can read Wikipedia without cost or registration Anyone can edit
          most Wikipedia articles without creating an account All Wikipedia
          content is published under free licenses (primarily Creative Commons
          Attribution-ShareAlike License) Users are free to copy, modify, and
          redistribute Wikipedia content for any purpose, including commercial
          use All text contributions automatically fall under these free
          licenses
        </span>
