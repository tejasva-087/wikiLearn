  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="flex-1 overflow-y-auto p-6 ">
        ...
        <br></br>
        <span>
          Citation practices work together with other core policies like Neutral
          Point of View and No Original Research. Proper sourcing helps maintain
          neutrality by representing all significant viewpoints proportionately
          and prevents original research by ensuring claims come from published
          reliable sources.Works alongside "No Original Research" and "Neutral
          Point of View" Verifiability alone doesn't guarantee inclusion
