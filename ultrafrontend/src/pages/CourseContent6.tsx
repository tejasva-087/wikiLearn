  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="flex-1 overflow-y-auto p-6 ">
        <h1 className="text-4xl font-bold mb-6 ">Mandatory Citations</h1>
        ...
        <br></br>
        <span>
          Inline citations are required for: Direct quotations Material whose
          verifiability has been challenged Material whose verifiability is
          likely to be challenged Contentious material about living and recently
          deceased persons The responsibility to provide reliable sources falls
          on the editor adding or restoring content, not on those questioning
          it. Unsourced or poorly sourced material may be removed, especially if
          challenged or concerning living persons.
        </span>
