  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="flex-1 overflow-y-auto p-6 ">
        <h1 className="text-4xl font-bold mb-6 ">Burden of Proof</h1>
        ...
        <br></br>
        <span>
          The responsibility to provide reliable sources falls on the editor
          adding or restoring content, not on those questioning it. Unsourced or
          poorly sourced material may be removed, especially if challenged or
          concerning living persons.The editor who adds content is responsible
          for providing appropriate citations. Reliable Sources: Academic and
          peer-reviewed publications University-level textbooks Books from
          respected publishing houses Mainstream magazines and newspapers
          Electronic media meeting similar criteria
        </span>
