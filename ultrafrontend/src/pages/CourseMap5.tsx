...
const steps = [
  ...
  {
    id: 3,
    title: "What Is NOT Original Research",
        ...
        <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 mb-4">
              Wikipedia's No Original Research (NOR) policy prohibits including
              material that isn't backed by reliable, published sources. This is
              one of Wikipedia's three core content policies, alongside Neutral
