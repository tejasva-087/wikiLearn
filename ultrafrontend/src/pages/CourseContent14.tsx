  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="flex-1 overflow-y-auto p-6 ">
        <h1 className="text-4xl font-bold mb-6 ">Use nonjudgmental language</h1>
        ...
        <br></br>
        <span>
          Wikipedia articles should employ neutral vocabulary that doesn't imply
          praise, criticism, or value judgments. Terms with emotional
          connotations are replaced with more neutral alternatives, and
          contentious characterizations are attributed to their sources rather
          than presented as facts.Present information in a disinterested tone
