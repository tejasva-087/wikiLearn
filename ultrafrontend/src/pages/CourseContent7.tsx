  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="flex-1 overflow-y-auto p-6 ">
        <h1 className="text-4xl font-bold mb-6 ">Direct quotations</h1>
        ...
        <br></br>
        <span>
          When using someone else's exact words, these must be clearly
          attributed, placed in quotation marks or block quotes, and cited to
          the source. Direct quotes should be used sparingly and only when the
          specific wording is relevant or important to the topic.Material whose
