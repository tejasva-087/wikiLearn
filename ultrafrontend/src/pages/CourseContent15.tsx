  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="flex-1 overflow-y-auto p-6 ">
        <h1 className="text-4xl font-bold mb-6 ">Avoid false balance</h1>
        ...
        <br></br>
        <span>
          Don't present minority views as having equal validity to mainstream
          positions.While Wikipedia presents multiple viewpoints, it doesn't
          give equal weight to all positions regardless of their prominence or
          support in reliable sources. Fringe theories or minority views should
          be represented proportionately to their significance in reliable
          sources, avoiding the impression that all viewpoints are equally valid
