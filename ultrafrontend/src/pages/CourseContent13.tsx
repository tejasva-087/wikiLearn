  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="flex-1 overflow-y-auto p-6 ">
        <h1 className="text-4xl font-bold mb-6 ">Avoid bias</h1>
        ...
        <br></br>
        <span>
          Editors must present content without bias, ensuring articles don't
          favor particular viewpoints. This means representing all significant
          perspectives fairly, using proportionate coverage based on the
          reliability of sources, and avoiding language that implicitly promotes
          certain positions over others.Don't state opinions as facts, contested
          assertions as facts, or facts as opinions.
        </span>
